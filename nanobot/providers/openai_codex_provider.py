...
class OpenAICodexProvider(LLMProvider):
    """Use Codex OAuth credentials to call the Responses API."""
    ...
    def __init__(
        ...
        super().__init__(api_key=None, api_base=api_base or DEFAULT_CODEX_BASE_URL)
    ...
    async def chat(
        ...
        url = _resolve_codex_url(self.api_base or DEFAULT_CODEX_BASE_URL)
        ...
        try:
            ...
            return LLMResponse(
                content=f"Error calling Codex: {str(exc)}",
                finish_reason="error",
            )
